...
export default function useVoiceRecognition() {
  ...
  return { itens, total, adicionarManual, removerItem, atualizarPreco, marcarItem, limparLista, isListening, isProcessing, transcript, feedback, provedorAtivo, startListening, stopListening };
}
