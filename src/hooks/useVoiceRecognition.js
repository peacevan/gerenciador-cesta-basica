...
export default function useVoiceRecognition() {
  const { itens, total, totalGeral, adicionarManual, removerItem, atualizarPreco, atualizarItem, marcarItem, limparLista, processarComandos } = useShoppingList();
  ...
  return { itens, total, totalGeral, adicionarManual, removerItem, atualizarPreco, atualizarItem, marcarItem, limparLista, isListening, isProcessing, transcript, feedback, provedorAtivo, startListening, stopListening, ambiguousCommands, clearAmbiguous };
}
